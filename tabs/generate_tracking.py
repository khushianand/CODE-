...
class GenerateTrackingTab(ttk.Frame):
    ...
    def _build_ui(self):
        """Handle the build ui step for this module workflow."""
    ...
    def _file_row(self, row, label, var, browse_command, save=False):
        """Handle the file row step for this module workflow."""
    ...
    def _load_sheets(self, path, combo, var):
        """Handle the load sheets step for this module workflow."""
    ...
    def _browse_master(self):
        """Handle the browse master step for this module workflow."""
    ...
    def _parse_with_optional_severity_fallback(self, path: str, sheet: str, label: str):
        """Handle the parse with optional severity fallback step for this module workflow."""
        try:
