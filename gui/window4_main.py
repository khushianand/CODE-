...
class Window4Main(ttk.Frame):
    ...
    def attach_log_handler(self):
        """Explain workflow and purpose of `attach_log_handler` in this module."""
    ...
    def _attach_stdio_redirects(self):
        """Explain workflow and purpose of `_attach_stdio_redirects` in this module."""
        import io
        import sys
        ...
        class _StreamToLog(io.TextIOBase):
            ...
            def write(self, s):
                """Explain workflow and purpose of `write` in this module."""
                text = str(s).rstrip()
                if text:
                    self.callback(text)
                return len(s)
    ...
    def append_log(self, msg: str):
        """Explain workflow and purpose of `append_log` in this module."""
